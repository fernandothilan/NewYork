   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "                      ADMIN TRIALS AND HEARINGS        13206.378160   \n",
       "...                                                             ...   \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "HOME AIDE                                  BROOKLYN                      0.000000  \n",
       "CORRECTION ADMINISTRATIVE AIDE             MANHATTAN                     0.000000  \n",
       "?SENIOR AUTOMOTIVE SERVICE WORKER          RICHMOND                      0.090000  \n",
       "SIGN LANGUAGE INTERPRETER                  BRONX                         0.000000  \n",
       "INVESTMENT TRUSTEE - DEFERRED COMPENSATION BROOKLYN                      0.000000  \n",
       "COMMUNICATION ELECTRICIAN                  MANHATTAN                  2119.150000  \n",
       "GRAD ASSISTANT \"C\"                         Unknown                     500.000000  "
      ]
     },
     "execution_count": 38,
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       ...
       "                                                ...  \n",
       "CONFIDENTIAL ASSISTANT TO THE COMMISSIONER          1\n",
       "ASST COMMISSIONER FOR PUBLIC  LEGIS AFFAIRS         1\n",
       "COORDINATOR OF VETERANS AFFAIRS                     1\n",
       "DIRECTOR OF MOTOR EQUIPMENT                         1\n",
       "SPECIAL ASSISTANT TO COMMISSIONER                   1\n",
       "Name: Title Description, Length: 1684, dtype: int64"
      ]
     },
     "execution_count": 42,
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "      <th colspan=\"2\" halign=\"left\">Regular Hours</th>\n",
       "      <th>...</th>\n",
       "      <th colspan=\"2\" halign=\"left\">Total OT Paid</th>\n",
       "      <th colspan=\"8\" halign=\"left\">Total Other Pay</th>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th></th>\n",
       "      <th>count</th>\n",
      ...
      "text/plain": [
       ...
       "OTHER                     40164.0  106045.025695   9695.488964  44034.0   \n",
       "QUEENS                        3.0   78213.000000   5918.417609  74796.0   \n",
       "ULSTER                        3.0   78213.000000   5918.417609  74796.0   \n",
       "\n",
       "                                                              Regular Hours  \\\n",
       "                            25%       50%       75%       max         count   \n",
       "Work Location Borough                                                         \n",
       "MANHATTAN               70025.0   84241.0   94198.0  143968.0      270896.0   \n",
       "OTHER                  100049.0  105142.0  113762.0  141862.0       40164.0   \n",
       "QUEENS                  74796.0   74796.0   79921.5   85047.0           3.0   \n",
       "ULSTER                  74796.0   74796.0   79921.5   85047.0           3.0   \n",
       "\n",
       "                                    ... Total OT Paid      Total Other Pay  \\\n",
       "                              mean  ...           75%  max           count   \n",
       "Work Location Borough               ...                                      \n",
       "MANHATTAN                 2.020526  ...           0.0  0.0        270896.0   \n",
       "OTHER                     0.000000  ...           0.0  0.0         40164.0   \n",
       "QUEENS                 1393.486667  ...           0.0  0.0             3.0   \n",
       "ULSTER                 1393.486667  ...           0.0  0.0             3.0   \n",
       "\n",
       "                                                                       \\\n",
       "                               mean          std       min        25%   \n",
       "Work Location Borough                                                   \n",
       "MANHATTAN                 20.293519   863.191011 -41937.54      0.000   \n",
       "OTHER                    -26.378918   755.675320 -39516.78      0.000   \n",
       "QUEENS                  7354.116667  5271.604338   4077.83   4313.600   \n",
       "ULSTER                 29232.493333  7070.550382  25116.85  25150.355   \n",
       "\n",
       "                                                      \n",
       "                            50%        75%       max  \n",
       "Work Location Borough                                 \n",
       "MANHATTAN                  0.00      0.000  44099.38  \n",
       "OTHER                      0.00      0.000  13032.81  \n",
       "QUEENS                  4549.37   8992.260  13435.15  \n",
       "ULSTER                 25183.86  31290.315  37396.77  \n",
       "\n",
       "[4 rows x 48 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2015-01-01   172.586062 -0.363655 -0.071304      -inf -0.939909 -0.424716   \n",
       "2016-01-01    -0.057217  0.111477  0.033265  1.480360  1.168553  0.214966   \n",
       "2017-01-01     0.032028  0.033162  0.037253 -0.392470 -0.029770  0.038236   \n",
       "2018-01-01    -0.028670  0.047851  0.002659  2.626622  0.472835  0.073947   \n",
       "2019-01-01     0.084719 -0.001849  0.084623  0.158497 -0.394909 -0.066828   \n",
       "\n",
       "                  75%       max  \n",
       "Fiscal Year                      \n",
       "2014-01-01        NaN       NaN  \n",
       "2015-01-01  -0.078692  1.478669  \n",
       "2016-01-01   0.083743  0.377682  \n",
       "2017-01-01   0.008625 -0.460938  \n",
       "2018-01-01   0.028120  0.017056  \n",
       "2019-01-01   0.005509  0.356493  "
      ]
     },
     "execution_count": 51,
     "metadata": {},
   ...
   "outputs": [
    {
     ...
     "traceback": [
      ...
      "\u001b[1;32m<ipython-input-1-555c9a51a0af>\u001b[0m in \u001b[0;36m<module>\u001b[1;34m\u001b[0m\n\u001b[1;32m----> 1\u001b[1;33m \u001b[0mdf\u001b[0m\u001b[1;33m[\u001b[0m\u001b[1;34m'Title Description'\u001b[0m\u001b[1;33m]\u001b[0m\u001b[1;33m.\u001b[0m\u001b[0msort_values\u001b[0m\u001b[1;33m(\u001b[0m\u001b[0mascending\u001b[0m\u001b[1;33m=\u001b[0m\u001b[1;32mFalse\u001b[0m\u001b[1;33m)\u001b[0m\u001b[1;33m\u001b[0m\u001b[0m\n\u001b[0m",
